...
//        });
    ...
    /**
     * Responds to the unread message icon click event
     */
...
//            if (mScrollView == mAppListView) {
    ...
    /**
     * Wrap up the VoiceServiceView with an external swipe.
     */
    ...
    val isCurrentWatchView: Boolean
        /**
         * Whether the current Launcher's View is a dial.
         *
         * @return
         */
    ...
    fun playUnReadMessageAnimator() {
        //TODO ：Add logic to hide spine dials
...
//        mDesktopView.stopUnReadMessageAnimator();
    ...
    /**
     * When the robot is disabled, this is displayed
     */
